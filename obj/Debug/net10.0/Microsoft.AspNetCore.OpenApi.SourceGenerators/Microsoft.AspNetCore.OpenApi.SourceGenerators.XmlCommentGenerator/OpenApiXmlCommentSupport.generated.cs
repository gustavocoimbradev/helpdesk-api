...
namespace Microsoft.AspNetCore.OpenApi.Generated
{
    ...
    file static class XmlCommentCache
    {
        ...
        private static Dictionary<string, XmlComment> GenerateCacheEntries()
        {
            ...
            cache.Add(@"T:helpdesk_api.Migrations.InitialCreate", new XmlComment(@"A base class inherited by each EF Core migration.", null, @"See <see href=""https://aka.ms/efcore-docs-migrations"">Database migrations</see> for more information and examples.", null, null, false, null, null, null));
            cache.Add(@"T:helpdesk_api.Migrations.Seeds", new XmlComment(@"A base class inherited by each EF Core migration.", null, @"See <see href=""https://aka.ms/efcore-docs-migrations"">Database migrations</see> for more information and examples.", null, null, false, null, null, null));
    ...
    {
        [global::System.Runtime.CompilerServices.InterceptsLocationAttribute(1, "jNDDXyAGw1iG246NTbiDFBIBAABQcm9ncmFtLmNz")]
